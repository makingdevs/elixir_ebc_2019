defmodule EbcWebappWeb.PostControllerTest do
  use EbcWebappWeb.ConnCase

  alias EbcWebapp.Publication

  @create_attrs %{body: "some body", publication_date: ~N[2010-04-17 14:00:00], title: "some title"}
  ...
  def fixture(:post) do
    {:ok, post} = Publication.create_post(@create_attrs)
    post
  end
