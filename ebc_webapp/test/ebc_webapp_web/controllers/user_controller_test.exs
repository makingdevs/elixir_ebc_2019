defmodule EbcWebappWeb.UserControllerTest do
  use EbcWebappWeb.ConnCase

  alias EbcWebapp.Twinder

  @create_attrs %{born_date: ~D[2010-04-17], email: "some email", full_name: "some full_name", username: "some username"}
  ...
  def fixture(:user) do
    {:ok, user} = Twinder.create_user(@create_attrs)
    user
  end
